...
class Admin(User):
    def _init_(self, password="",brand="", model="", seating_capacity="", price_per_day=0, fuel_type="", car_type="",
            fuel_average="",availability=True):
        super()._init_(password)
...
#----------------------------------------REMOVE CAR FLEET---------------------------------------------------
    ...
    def display_user_info(self):
        ...
        safe_email = self.email.replace("@", "at").replace(".", "dot")
